    ...
    <div class="col-md-12 col-sm-10">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-10">
                ...
                <form action="{{ route('paid_search_bill_payment') }}" method="GET">
                    @csrf
                    <div class="accounts" style="margin-bottom: 30px">
                        ...
                        <div class="flex" style="justify-content: space-evenly">
                            <div>
                                ...
                                <select name="customer_id" id="customer_id" class="chosen-select" style="width: 200px" value="{{ request('fk_customer_id') ?? ''  }}">
