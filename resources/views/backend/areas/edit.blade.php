...
@section('content')
    ...
    <div class="col-md-10" style="border: 3px solid #438EB9;
        ...
        <div class="table-header">
            <p style="font-size: 15px;">Update this Area</p>
        </div>

        <div>
            {{-- <h3 class="header smaller lighter blue">Update this Area</h3> --}}
            <div class="clearfix">
                        ...
                        <div class="tile-body">
                            <div class="form-group">
                                ...
                                <label class="ace-file-input">
                                    ...
                                    <input class="form-control" type="text" name="area_name" value="{{ $area->area_name }}"
