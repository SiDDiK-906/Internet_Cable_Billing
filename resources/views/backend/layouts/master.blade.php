...
<head>
    ...
    <!-- custom fonts -->
    <link href="{{ asset('https://fonts.googleapis.com/css2?family=Ubuntu:wght@300;400&display=swap') }}"
        rel="stylesheet">

    <!-- custom title icon -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('assets/backend/images/ace-title-icon.png') }}">
    ...
    {{-- chosen css --}}
    {{-- <link rel="stylesheet" href="{{ asset('assets/backend/css/chosen.min.css') }}" class="ace-main-stylesheet" /> --}}
    <link rel="stylesheet" href="{{ asset('assets/backend/css/chosen.css') }}" class="ace-main-stylesheet" />
    ...
    {{-- select 2 css --}}
    <script src="{{ asset('assets/backend/css/select2.min.css') }}"></script>
...
<body class="no-skin">
    @include('backend.layouts._partials.navbar')
    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <!-- main body start -->
        <div class="main-content" style="font-family: 'Ubuntu', sans-serif;">
                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">
                            ...
                            <a href="">
                                {{ ((new \App\Services\SidebarControlService())->getBreadCramb()) }}
    ...
    <script type="text/javascript">
        if ('ontouchstart' in document.documentElement) document.write(
            "<script src='assets/backend/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
    </script>
    ...
    {{-- chosen scripts --}}
    <script src="{{ asset('assets/backend/js/chosen.jquery.min.js') }}"></script>
    <script src="{{ asset('assets/backend/js/init.js') }}"></script>
    <script src="{{ asset('assets/backend/js/spin.js') }}"></script>
    ...
    <script>
        $('#delete').on("click", function(e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Yout won't be able to revert this",
                icon: 'warning',
        ...
        // for generating bill
        $('#generate_bill_button').on("click", function(e) {
            e.preventDefault();
            var self = $(this);
            console.log(self.data('title'));
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    location.href = route('store-bill-generate') url('/store-bill-generate');
                }
            })
        })
        ...
        // for paid the bill
        $('#unpaid_button').on("click", function(e) {
            e.preventDefault();
            var self = $(this);
            console.log(self.data('title'));
