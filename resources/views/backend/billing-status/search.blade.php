                                ...
                                <div class="main-select">
                                    <select name="year">
                                        ...
                                        @for($i= date('Y'); $i >= date('Y') - 3; $i--)
                                            <option value="{{ $i }}" {{ Session::get('year') == $i ? 'selected' : '' }}>{{ $i }}</option>
                                        @endfor
                                ...
                                <div class="main-select">
                                    <select name="month">
                                        ...
                                        @for($i = 1; $i <= 12; $i++)
                                            ...
                                            <option value="{{ $i }}" {{ Session::get('month') == $i ? 'selected' : '' }}>{{ Carbon::parse($month)->format('F') }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
                                    ...
                                    @foreach ($areas as $area)
                                        <tr>
                                            ...
                                            <td class="item2">
                                                ...
                                                @foreach ($area->BillMultiMonth as $bill)
                                            ...
                                            <td class="item3">
                                                ...
                                                @foreach ($area->BillPaymentMultiMonthStatus as $bill)
