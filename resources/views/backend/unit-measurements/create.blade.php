...
@section('content')
    ...
    <div class="col-md-10"
        ...
        <div class="table-header">
            <p style="font-size: 15px;">Add a new Unit of Measurement</p>
        </div>
        <div>
            <div class="clearfix">
        ...
        <div style="margin-top: 15px;">
            <div class="tile">
                <form action="{{ route('store-unit-measurement') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <label class="ace-file-input">
                                <input class="form-control" type="text" name="uom_name" placeholder="Enter a Unit of Measurement Name" required>
                            </label><br>
