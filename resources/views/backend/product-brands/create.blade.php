...
@section('content')
    ...
    <div class="col-md-10"
        ...
        <div class="table-header">
            <p style="font-size: 15px;">Add a new Brand</p>
        </div>
        <div>
            <div class="clearfix">
        ...
        <div style="margin-top: 15px;">
            <div class="tile">
                <form action="{{ route('store-product-brand') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <label class="ace-file-input">
                                <input class="form-control" type="text" name="brand_name" placeholder="Enter a Brand Name" required>
                            </label><br>
