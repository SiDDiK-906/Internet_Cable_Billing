...
@section('content')
    ...
    <div class="col-md-12 col-sm-10">
        <div style=" text-align:right;" class="add-slider">
            <a class="btn btn-primary icon-btn" href="{{ route('create-product-brand') }}"><i class="fa fa-plus"></i> Add New Product Brand
            </a>
        </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($productBrands as $productBrand)
                                    <tr>
                                        ...
                                        <td> {{ Str::limit($productBrand->brand_name ?? '', 30) }}</td>
                                        <td>
                                            @if ($productBrand->status == 1)
                                                <div class="btn-group action-group">
                                                    <a class="btn btn-success"
                                                        href="{{ route('deactive-product-brand', $productBrand->id) }}">
                                            ...
                                            @else
                                                <div class="btn-group action-group">
                                                    <a class="btn btn-secondary"
                                                        href="{{ route('active-product-brand', $productBrand->id) }}">
                                        ...
                                        <td>
                                            <div class="btn-group action-group">
                                                <a class="btn btn-primary" href="{{ route('edit-product-brand', $productBrand->id) }}">
                                                    <i class="fa fa fa-edit"></i>
                                                </a>
                                                <a type="submit" id="delete" class="btn btn-danger"
                                                    href="{{ route('destroy-product-brand', $productBrand->id) }}">
