...
@section('content')
    ...
    <div class="col-md-10"
        ...
        <div class="table-header">
            <p style="font-size: 15px;">Add a new Payment Option</p>
        </div>
        <div>
        ...
        <div style="margin-top: 15px;">
            <div class="tile">
                <form action="{{ route('store-payment-option') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="tile-body">
                        <div class="form-group">
                            ...
                            <label class="ace-file-input">
                                <input class="form-control" type="text" name="name" placeholder="Enter a Payment Name" required>
                            </label><br>
                            <label class="ace-file-input">
                    ...
                    <div class="tile-footer ">
                        <button class="btn btn-primary" type="submit">
                            <i class="fa fa-fw fa-lg fa-check-circle"></i>Add Payment Option
                        </button>
